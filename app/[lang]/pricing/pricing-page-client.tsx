...
const CREDIT_PACKS: Array<{
  ...
  { tier: 'starter', name: PRICING_TIERS.starter.name, price: `$${PRICING_TIERS.starter.amount}`, credits: PRICING_TIERS.starter.credits, label: 'Start here', description: 'For a few finished portraits and style experiments.' },
  { tier: 'pro', name: PRICING_TIERS.pro.name, price: `$${PRICING_TIERS.pro.amount}`, credits: PRICING_TIERS.pro.credits, label: 'More portraits', description: 'For several pets, gifts, or seasonal versions.' },
    ...
    <main className="min-h-screen bg-cream">
      ...
      <section className="relative z-10 -mt-12 px-4 pb-20">
        <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-3">
          ...
          <OutcomeCard featured eyebrow="Keep one favorite" title="HD Digital Portrait" price={`$${HD_UNLOCK.amount}`} suffix="one portrait" description="The clean digital file when you already love the result." icon={<Download className="h-6 w-6" />} features={['Watermark-free PNG', 'Original generation resolution', 'Personal print license']} button="Create, then unlock HD" onClick={() => startPortrait('hd_unlock')} />
